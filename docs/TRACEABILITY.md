...
| `S5-QA-P4-001` | توافق Backup القديم وتشغيل فحوص Phase 4 آلياً قبل Phase 5 | P4-HARD-001 / P4-P45-RECONCILIATION | PARTIAL DEVICE GATE PASS — CURRENT OWNER SESSION COMPLETE; CUTOVER GATES CARRIED FORWARD | Node 22 CI + Workers Build `6e7ced6d` + PDF/Notes MatePad PASS؛ Worker Ink، full Backup، large-PDF، corrupt/low-storage/failure-safe checks تبقى PENDING/UNVERIFIED |
| `S5-UX-P45-ROUTING-001` | توجيه Phase 4.5 بعد مصالحة الأدلة من دون اختراع نتائج جهاز | P4-P45-RECONCILIATION / PR #16 | DRAFT PR OPEN — B PASS / MUTATION GUARD PASS / FINAL PR-HEAD CI RECHECK PENDING | قرار المالك 2026-08-09؛ PASS المسجل محفوظ؛ Ink Batch 3 مؤجل؛ Phase 5 محظورة؛ لا Merge |
...
| `S5-UX-P45-SHELL-001` | App Shell وتنقل Responsive معزولان من دون Core أو Ink | P4.5-UX-IMPLEMENTATION-001 | ELIGIBLE / NOT STARTED | `prototype/p45-product-shell-web/**` replacement boundary؛ خمس وجهات؛ accessibility/static checks؛ no route cutover |
