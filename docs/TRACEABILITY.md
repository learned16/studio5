...
| `S5-QA-AUTOPILOT-003` | تحقق مسار التسليم باشتراك Codex الحالي فقط | OPS-AUTOPILOT-003 | BACKLOG — NEXT AUTOMATION TASK | Project واحد + Supervisor + A/B/C حسب الحاجة + mutation guard + native tests/guards/CI + Draft PR؛ لا API key ولا Full access ولا auto-merge |
