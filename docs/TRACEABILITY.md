...
| `S5-PREVIEW-002` | فحص حزمة P3 الساكنة وحدود Cloudflare والمسارات والأصول قبل الربط | P4-PREVIEW-001 | CODE + PR CI PASS / NOT DEPLOYED / DEVICE GATE PENDING | PR #3: GitHub Actions 3/3 على Node 22؛ 249 ملفاً؛ أكبر ملف 1,304,896 bytes؛ 4/4 routes HTTP 200؛ 404 بلا fallback؛ PDF/SW same-origin contracts PASS |
