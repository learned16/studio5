...
| `S5-UX-I18N-001` | عرض محتوى المستخدم العربي والمختلط باتجاه تلقائي من دون تغيير النص الأصلي | P4.5-UX-ARABIC-001 | LOCAL AUTOMATED PASS / CI PENDING | Arabic HTML 5/5 + P3 27/27 + Static Preview PASS؛ Arabic PDF canvas MatePad verification pending |
