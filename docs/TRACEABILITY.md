...
| `S5-UX-P45-SHELL-001` | App Shell وتنقل Responsive معزولان من دون Core أو Ink | P4.5-UX-IMPLEMENTATION-001 | IMPLEMENTED / LOCAL CHECKS PASS / REMOTE DELIVERY PENDING | خمس وجهات Hash بترتيبها المعتمد؛ LTR و`dir=auto` وRail/Bottom Navigation وحالات accessibility؛ tests `10/10` وbuild وHTTP closure + executable DOM navigation smoke وFull regression PASS؛ لا Browser/Device claim ولا route cutover |
