...
| P4-INK-EXTRACT-002 | استخراج تحويلات Ink/Viewport إلى وحدة pure مع إبقاء P0 مطابقاً | `refactor/p0-ink-coordinate-transforms` | Codex | READY FOR REVIEW — LOCAL PASS / PR CI PENDING | الوحدة الجديدة 41/41؛ P0 78/78؛ Characterization 22/22؛ Core 100/100؛ P3 24/24؛ Build وفحص المتصفح المحلي PASS؛ Pinch الحقيقي وMatePad غير منفذين |
