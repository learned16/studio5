...
| P4-INK-EXTRACT-002 | استخراج تحويلات Ink/Viewport إلى وحدة pure مع إبقاء P0 مطابقاً | `refactor/p0-ink-coordinate-transforms` | Codex | REVISION READY — LOCAL PASS / BUILD CLOSURE PASS / CI PENDING / MATEPAD MULTI-TOUCH PENDING | FIX-1 يغلق dist imports وService Worker ويزيل allocation لكل نقطة؛ Built browser وOffline reopen PASS؛ Pinch الموروث مسجل للدفعة اللاحقة |
