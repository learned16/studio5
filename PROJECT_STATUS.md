...
| P2-GATE-001 | ربط P0 Ink بـNotebook Core ونشر Demo | `codex/p2-notebook-demo-gate` | Codex | IMPLEMENTED 15/15 - DEPLOY APPROVAL PENDING | `prototype/p0-ink-web/**` ووثائق المهمة والحالة |
